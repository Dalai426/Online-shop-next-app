"use client";
import toBase64 from "@/backend/utils/toBase64";
...
const UpdateProfileComp= () => {
    ...
    const [avatarPreview, setAvatarPreview] = useState("/images/default_product.jpg");

    const {user,error, clearError,loading,updateProfile}=useContext(AuthContext);
